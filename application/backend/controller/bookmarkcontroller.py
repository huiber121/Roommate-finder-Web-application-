...
def room_bookmark():
    ...
    if checker:
        ...
        if checkdup == 0:
            ...
            LOGGER.info('Add Room bookmark  room id: {%s} to userid {%s}',roomid,user_id)
            return message
...
def user_bookmark():
    ...
    if checker:
        ...
        if checkdup == 0:
            ...
            LOGGER.info('Add bookmarked_userid: {%s} to userid {%s}',bookmarked_userid,user_id)
            return message
        return "Duplicate bookmark"
    return "please login"
def delete_user_bookmark():
    ...
    if checker:
        ...
        LOGGER.info('Delete Userid {%s} user bookmark  bookmarked_userid: {%s}',user_id,bookmarked_userid)
        return message
    return "please login"
