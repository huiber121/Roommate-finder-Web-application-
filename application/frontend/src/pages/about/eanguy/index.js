          ...
          <div className="col-xs-11 col-sm-8 col-md-6 col-lg-6">
            <p className="description">
             ...
             I hope to start my own startup or company after finishing school.
               <br />
              <br />
              I have experienced in backend during my school year, but now I want
              to have more experience in database. I am testing out my capability
              and I hope to excel in it.
            </p>
          </div>
        </div>
        {/* Waves */}
