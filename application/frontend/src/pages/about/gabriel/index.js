    ...
    <div>
      ...
      <div className="row header-row center-xs center-sm center-md center-lg">
        <div className="col-xs-12">
          <h1 className="header-title">Gabriel Pena</h1>
        </div>
        <div className="col-xs-12">
      ...
      <div className="row description-row center-xs center-sm center-md center-lg">
        <div className="col-xs-11 col-sm-8 col-md-6 col-lg-6">
          <p className="description">
            I am currently a Senior here at SF State and I hope to graduate by the end
            of Spring 2022. I hope to get a software engineering or an IT position 
            when I graduate. 
             <br />
            <br /> 
            In my time at school I've worked with many different languages such as C++,
            Java, Python, Javascript and others. I won't say I'm an expert because
            theres always something new to learn but I like think I'm decent. I also 
            have experience with MySQL and mongoDB. I hope this experience can be put to good use 
