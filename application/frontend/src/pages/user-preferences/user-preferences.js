...
const UserPreferences = (props) => {
  const UserPreferencesValidationSchema = Yup.object.shape({
    type: Yup.string(),
    bedrooms: Yup.string(),
  ...
  const submitForm = async (values) => {
    const requestData = await axios.post(
      `${process.env.REACT_APP_HOST_BASE}/api/userPreference`,
      {
        Type: values.type,
        ...
        RestroomPrivacy: values.restroomPrivacy
      },
  ...
  return <div className="preferences-root-container">
                        ...
                        <p className="control">
                          <div className="select is-pulled-left">
                            ...
                            >
                              ...
                              <option value="parking included">Parking Included</option>
                          </select>
                          </div>
                        </p>
                      ...
                      <div className="field">
                        <p className="control">
                          <div className="select is-pulled-left">
                            ...
                            >
                              <option value="">None</option>
                              <option value="not college oriented">Not College Oriented</option>
                              <option value="college oriented">College oriented</option>
                          </select>
                          </div>
                        </p>
                        ...
                        <p className="control">
                          <div className="select is-pulled-left">
                            ...
                            >
                              ...
                              <option value="not disability friendly">Not Disability Friendly</option>
                          </select>
                          </div>
                        </p>
                      ...
                      <div className="field">
                        <p className="control">
                          <div className="select is-pulled-left">
                            ...
                            >
                              <option value="">None</option>
                              <option value="rent not negotiatable">Rent Not Negotiable</option>
                              <option value="rent negotiatable">Rent Negotiatable</option>
                          </select>
                          </div>
                        </p>
                        ...
                        <p className="control">
                          <div className="select is-pulled-left">
                            ...
                            >
                              ...
                              <option value="no private restroom">No Private Restroom</option>
                          </select>
                          </div>
                        </p>
